...
The custom nextline is included with adjusting degree scheme. The NL prefetchig part is modified in a way not to 
prefetch next line if current line is accessed by some CPLX IP in the past . Unnfortunately it never get's triggered
